  ...
  const handleSave = () => {
    const saving = async (
      ...
      try {
        ...
        metadata.listDate = new Date().toISOString().slice(0, 10);
        ...
        <div className="p-4 md:p-8 w-full gap-y-6 flex flex-col">
          ...
          <AppDetailsRow
            ...
            helpTexts={[
              {
                title: "",
                desc: "select the chains and fill in your contract addresses",
              },
            ]}
          >
          ...
          <AppDetailsRow
            ...
            helpTexts={[
              {
                title: "Sub-category",
                desc: "Don’t see your sub category? Request it here",
              },
              {
                title: "Is self moderated?",
                desc: "The filed signifies if the dApp developers have a moderation in place for the content posted/generated by the dApp or it's users",
              },
            ]}
          >
            <div className="flex flex-col gap-y-2">
